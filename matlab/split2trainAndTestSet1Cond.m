function [ XTraincurCond, XTestcurCond,trialsNumAndLength,patternsCrossValInd] = split2trainAndTestSet1Cond( X,cond ,yLabled,trainTestRatio)
...
%   Detailed explanation goes here
    ...
    for jj=1:length(cond)
        ...
        limitedP=sort(limitedP);
        for ii=1:length(limitedP)
